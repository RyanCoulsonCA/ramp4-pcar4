...
import { _ as H, d as L, F as X, G as ee } from "./main-BDVKvomh.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-D3Xnq0Fa.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-B4LI0JHE.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DtY9FYj_.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BrZ0F8tw.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CBDDRSEc.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CzQjBrOD.js")))
      }), s;
    }), n = (s) => {
