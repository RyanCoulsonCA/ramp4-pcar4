...
import { _ as H, d as L, F as X, G as ee } from "./main-h33GLKJq.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Bz-bH3OB.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-D9R-RDYH.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CFVJlJPk.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-C1bwKs1A.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DoVGBlfM.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D7kG1kW3.js")))
      }), s;
    }), n = (s) => {
