...
import { _ as H, d as L, F as K, G as X } from "./main-CMpOAF8O.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CLPB2VU3.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-2ss7L3LT.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-D7UmAHkg.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DgXLw5Ky.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DtJK9H9c.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Dx0e0OfX.js")))
      }), s;
    }), n = (s) => {
