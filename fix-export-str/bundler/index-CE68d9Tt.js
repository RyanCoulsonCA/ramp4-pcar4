...
import { _ as H, d as L, F as K, G as X } from "./main-d9txDjBC.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DH3rjY5d.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Dy_vPw6o.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-vEQpJ4uv.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-ZIQX19Ee.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D_m7jRo-.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CsBDBkmT.js")))
      }), s;
    }), n = (s) => {
