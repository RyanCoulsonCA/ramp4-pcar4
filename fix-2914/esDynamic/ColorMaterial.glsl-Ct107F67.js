import{n as e}from"./glsl-EDZkDhgF.js";import{t}from"./ShaderBuilder-Di-26_tn.js";import{t as n}from"./Float4PassUniform-R_rVPKlL.js";import{a as r,i}from"./AlphaCutoff-D0n8uWZM.js";import{t as a}from"./ObjectAndLayerIdColor.glsl-C3sEfoJy.js";import{t as o}from"./VisualVariables.glsl-CCVsH3Dp.js";import{n as s}from"./View.glsl-YsNDLcX0.js";import{t as c}from"./TerrainDepthTest.glsl-DZ7tKbZj.js";import{t as l}from"./OutputColorHighlightOLID.glsl-DYmc42KH.js";import{t as u}from"./Transform.glsl-B8LYsJdc.js";import{t as d}from"./VertexColor.glsl-DkZ0DT-i.js";function f(f){let p=new t,{vertex:m,fragment:h,attributes:g,varyings:_}=p,{hasVVColor:v,hasVertexColors:y}=f;return s(m,f),p.include(u),p.include(d,f),p.include(o,f),p.include(a,f),h.include(r,f),p.include(l,f),p.include(c,f),g.add(`position`,`vec3`),v&&g.add(`colorFeatureAttribute`,`float`),y||_.add(`vColor`,`vec4`),_.add(`vpos`,`vec3`,{invariant:!0}),m.uniforms.add(new n(`uColor`,e=>e.color)),m.main.add(e`
      vpos = position;
      forwardVertexColor();
