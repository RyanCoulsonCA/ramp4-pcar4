import{c as e,r as t}from"./Emissions.glsl-C1fRgyHC.js";import{n,t as r}from"./glsl-EDZkDhgF.js";import{t as i}from"./Float3PassUniform-BEhcqx4m.js";import{t as a}from"./FloatPassUniform-gHcGW-mi.js";import{t as o}from"./Texture2DPassUniform-RVTT2Sjh.js";import{t as s}from"./ShaderBuilder-Di-26_tn.js";import{n as c}from"./MaterialUtil-NovS1QhH.js";import{t as l}from"./Float4PassUniform-R_rVPKlL.js";import{a as u,t as d}from"./AlphaCutoff-D0n8uWZM.js";import{a as f,i as p,t as m}from"./VisualVariables.glsl-CCVsH3Dp.js";import{n as h,t as g}from"./View.glsl-YsNDLcX0.js";import{t as _}from"./MixExternalColor.glsl-DkTLVBbV.js";import{t as v}from"./TerrainDepthTest.glsl-DZ7tKbZj.js";import{t as y}from"./OutputColorHighlightOLID.glsl-DYmc42KH.js";import{r as b}from"./VerticalOffset.glsl-BXr3ZmRy.js";import{t as x}from"./Transform.glsl-B8LYsJdc.js";import{t as S}from"./VertexColor.glsl-DkZ0DT-i.js";import{a as C,i as w,n as T,o as E,r as D,t as O,u as k}from"./DefaultMaterialAuxiliaryPasses.glsl-4bf1MKgm.js";import{a as A,i as j,n as ee,o as M,r as N,t as P}from"./SnowCover.glsl-BNaZ-W5O.js";import{a as F,c as I,n as L,s as R,t as z}from"./ReadShadowMap.glsl-DgBURkCd.js";function B(B){let V=new s,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(h(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(m,B),V.include(w,B),V.include(b,B),V.include(v,B),!e(K))return V.include(O,B),V;g(V.vertex,B),V.include(k,B),V.include(x),q&&V.include(E),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(t,B),V.include(D,B),V.include(C,B),V.include(S,B),U.include(f),U.include(p),U.uniforms.add(new l(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?L:z,B),U.main.add(n`
    forwardVertexColor();
