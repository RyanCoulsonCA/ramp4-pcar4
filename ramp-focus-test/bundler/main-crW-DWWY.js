...
import { ref as f, computed as N, markRaw as Q, defineComponent as M, inject as ve, reactive as we, watch as It, onBeforeUnmount as dt, resolveDirective as O, withDirectives as k, openBlock as v, createElementBlock as w, withKeys as cs, withModifiers as Zt, onMounted as Je, normalizeClass as oe, normalizeStyle as Oi, createVNode as re, Transition as ki, withCtx as te, createBlock as W, resolveDynamicComponent as us, mergeProps as ps, TransitionGroup as Mi, Fragment as He, renderList as ht, unref as S, nextTick as Ot, renderSlot as Pe, createElementVNode as y, vShow as ds, resolveComponent as Z, createTextVNode as at, toDisplayString as U, createCommentVNode as G, onUpdated as hs, Teleport as fs, getCurrentInstance as ms, useTemplateRef as hi, createApp as Pi, toRaw as _e, h as ys, render as Ut, defineAsyncComponent as gs } from "vue";
  ...
  async projectExtent(e, t) {
    const i = (m, A, b) => {
      ...
      if (b === 1)
        return [m, $, A];
      if (b > 1) {
        const L = i(m, $, b - 1), P = i($, A, b - 1);
        return L.concat(P.slice(1));
      }
      return [[]];
...
const Zs = ["data-cy"], Hi = /* @__PURE__ */ M({
    ...
    return (n, c) => {
      ...
      return v(), w("div", {
        ...
        re(ki, {
          ...
          default: te(() => [
            k((v(), W(us(s.panel.route.screen), ps({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  for (const [i, r] of e)
    t[i] = r;
  return t;
}, Qs = /* @__PURE__ */ Fe(Xs, [["__scopeId", "data-v-197830c4"]]), er = ["content", "aria-label"], ei = /* @__PURE__ */ M({
...
}), tr = { class: "h-full flex flex-col" }, ir = { class: "w-full flex mb-6" }, sr = ["content", "aria-label"], rr = /* @__PURE__ */ M({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(s) {
    ...
    return (o, a) => {
      const l = Z("panel-screen"), n = O("tippy");
...
const ar = ["content"], nr = { class: "flex items-center text-left" }, lr = { class: "select-text cursor-text" }, cr = ["content"], ur = {
...
}, vr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, br = { class: "pb-8 border-b border-gray-600" }, Ar = { class: "absolute flex right-3 top-3" }, wr = ["content", "aria-label"], Er = /* @__PURE__ */ M({
  __name: "caption-button",
  setup(s) {
    const e = Re(), { t } = Y(), i = N(() => e.notificationNumber), r = () => e.clearAll();
    return (o, a) => {
      const l = Z("close"), n = O("tippy");
      return v(), W(ei, {
        position: "top-start",
...
}), xr = /* @__PURE__ */ Fe(Er, [["__scopeId", "data-v-3623a7d2"]]), Sr = { class: "flex hover:text-white" }, Ir = ["aria-label"], _r = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Tr = ["aria-label", "content"], Lr = { class: "pb-8 border-b border-gray-600 mb-10" }, Rr = { class: "absolute right-5 top-5" }, $r = { class: "select-text" }, Cr = { class: "font-bold cursor-text" }, Or = { class: "text-sm cursor-text" }, kr = { class: "text-sm cursor-text" }, Mr = /* @__PURE__ */ M({
  ...
  setup(s) {
    ...
    return (l, n) => {
      const c = Z("close"), u = Z("dropdown-menu"), p = O("tippy"), d = O("focus-item");
      return k((v(), W(u, {
  ...
  setup(s) {
    ...
    return (A, b) => {
      const $ = Z("dropdown-menu"), L = O("truncate"), P = O("tippy");
      return v(), w("div", Nr, [
        re(Pr, {
        ...
        a.value?.text.disabled ? G("", !0) : k((v(), w("span", Ur, [
        ...
        y("div", Br, [
          l.value?.disabled ? G("", !0) : k((v(), w("div", Vr, [
          ...
          o.value?.disabled ? G("", !0) : k((v(), w("button", {
            key: 1,
            type: "button",
...
}), Xr = /* @__PURE__ */ Fe(Zr, [["__scopeId", "data-v-a451db5c"]]), Qr = { class: "flex items-center mb-20" }, eo = { class: "text-xl" }, to = /* @__PURE__ */ M({
...
}), st = B("instance", () => ({ started: f(!1) })), io = { class: "outer-shell h-full relative" }, so = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, ro = { class: "absolute top-8 w-full flex justify-center" }, oo = {
  key: 1,
  class: "w-full h-full"
}, ao = /* @__PURE__ */ M({
  __name: "shell",
  setup(s) {
    ...
    return (c, u) => {
      ...
      return k((v(), w("div", io, [
        ...
        (v(!0), w(He, null, ht(n(), (d) => (v(), W(fs, {
          to: d.teleport?.target,
          key: d.id
        }, [
          (v(), W(Hi, {
            key: `${d.id}`,
...
}), no = /* @__PURE__ */ Fe(ao, [["__scopeId", "data-v-7dc670e1"]]), lo = M({
  name: "App",
  components: { Shell: no },
  setup() {
    const s = ms();
...
const wo = {
  mounted(s) {
    [...document.querySelectorAll(".outer-shell")].some((t) => t.contains(s)) && zt.push(new Eo(s));
  },
  beforeUnmount(s) {
...
const To = ["content"], Lo = {
  ...
  setup(s, { expose: e }) {
    ...
    return Je(() => {
      ...
      const L = Z("back"), P = Z("panel-options-menu"), V = Z("left"), ye = Z("right"), Qe = Z("pin"), Nt = Z("expand"), Ft = Z("minimize"), Dt = Z("close"), I = O("truncate"), R = O("focus-item"), ae = O("tippy");
      return k((v(), w("div", {
...
}), Po = { class: "relative" }, No = ["content", "aria-label"], Fo = ["transform"], Do = /* @__PURE__ */ M({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Go = { class: "relative" }, Uo = ["content", "aria-label"], Bo = /* @__PURE__ */ M({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Vo = { class: "relative" }, zo = ["content", "aria-label"], qo = /* @__PURE__ */ M({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), Ko = { class: "relative" }, Zo = ["content", "aria-label"], Xo = /* @__PURE__ */ M({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), Qo = { class: "relative" }, ea = ["content", "aria-label"], ta = /* @__PURE__ */ M({
  __name: "right",
  props: {
    active: Boolean
  },
  ...
  tabindex: "-1"
}, ha = ["content", "aria-label"], fa = /* @__PURE__ */ M({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    return (e, t) => {
      const i = O("focus-item"), r = O("tippy");
      return v(), w("div", da, [
        k((v(), w("button", {
          type: "button",
  ...
  class: "relative",
  tabindex: "-1"
}, ya = ["aria-label", "content"], ga = /* @__PURE__ */ M({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    ...
    return (r, o) => {
      const a = O("focus-item"), l = O("tippy");
      return v(), w("div", ma, [
        k((v(), w("button", {
          type: "button",
...
const ii = async (s) => {
  ...
  let o;
  i ? (console.error("GeoName service targeting Lat Lon failed"), s.failedServs.push("geoname"), o = []) : o = r.items, s.addResult(Xi(s.config, o));
}, Ca = async (s) => {
...
const Na = B("geosearch", () => {
  const s = f(new Ii("en", void 0)), e = f({
    ...
    () => new Promise((L) => {
      s.value.fetchTypes().then((P) => {
        P.sort((V, ye) => V.name > ye.name ? 1 : -1), L(P);
      });
    })
  );
  function d(L, P) {
  ...
  function g(L) {
    n.value = !0;
    const P = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim();
    if (!P)
      a.value = [], l.value = [], n.value = !1;
    else if (P && P !== o.value || L) {
      const V = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(V), s.value.query(`${P}*`).then((ye) => {
          c.value = ye.failedServs, o.value = P, l.value = ye.results;
          const Qe = _i(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function b(L) {
    ...
    L = L.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), r.value = Array.from(L).map((V) => Object.keys(P).includes(V) ? "[" + V + P[V] + "]" : V.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function $(L) {
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((P) => {
          const V = o.pattern(
            m,
            A,
            (ye) => (
...
const Bn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-Bprm-moK.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CsnPafS5.js"), "../fixtures/basemap/index.ts": () => import("./index-BfYugs2z.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DUortRFb.js"), "../fixtures/details/index.ts": () => import("./index-U0c4FCCf.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DyOJ6Idr.js"), "../fixtures/export-legend/index.ts": () => import("./index-I6IoeaTw.js"), "../fixtures/export-map/index.ts": () => import("./index-BR91X6rL.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Bl6OLpUS.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-BF1BaQns.js"), "../fixtures/export-timestamp/index.ts": () => import("./index--OlihTnL.js"), "../fixtures/export-title/index.ts": () => import("./index-DKgo_jIA.js"), "../fixtures/export/index.ts": () => import("./index-scU9oUfl.js"), "../fixtures/extentguard/index.ts": () => import("./index-aG6Z47Z8.js"), "../fixtures/gazebo/index.ts": () => import("./index-D4K228sZ.js"), "../fixtures/geosearch/index.ts": () => import("./index-DhXA8nK6.js"), "../fixtures/grid/index.ts": () => import("./index-DwL2Lg5U.js"), "../fixtures/help/index.ts": () => import("./index-ByyqR9u0.js"), "../fixtures/hilight/index.ts": () => import("./index-2_AcfpeV.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DhT449jq.js"), "../fixtures/legend/index.ts": () => import("./index-BbHaaITQ.js"), "../fixtures/mapnav/index.ts": () => import("./index-D0EGSkIA.js"), "../fixtures/metadata/index.ts": () => import("./index-bAukjSUb.js"), "../fixtures/northarrow/index.ts": () => import("./index-CJR5H7DT.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CKfkKN7Z.js"), "../fixtures/panguard/index.ts": () => import("./index-qh6b2vab.js"), "../fixtures/scrollguard/index.ts": () => import("./index-0dtzwyvI.js"), "../fixtures/settings/index.ts": () => import("./index-DGpn-1Gc.js"), "../fixtures/snowman/index.ts": () => import("./index-DlpY65Gh.js"), "../fixtures/wizard/index.ts": () => import("./index-BPSFe-R0.js") });
class Vn extends J {
  /**
...
const Hn = /* @__PURE__ */ Fe(jn, [["render", Wn], ["__scopeId", "data-v-a3c61802"]]), Yn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-grOBxyJ7.js"), "../fixtures/basemap/screen.vue": () => import("./screen-7XBdaJEJ.js"), "../fixtures/export/screen.vue": () => import("./screen-CIIJXCci.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BMb8N0Bv.js"), "../fixtures/grid/screen.vue": () => import("./screen-DhAk0tiN.js"), "../fixtures/help/screen.vue": () => import("./screen-Co8DrLFm.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BBGvEiN6.js"), "../fixtures/legend/screen.vue": () => import("./screen-DgMAJ7os.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BNSWXXnB.js"), "../fixtures/settings/screen.vue": () => import("./screen--thSaa7X.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CIDxV8Dy.js") });
class St extends J {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Fri May 30 15:15:03 2025 -0400", hash: "3b1b8018218c2ffe037c3929ce03d5b8365645b6" };
console.info(
